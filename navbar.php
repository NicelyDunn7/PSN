      ...
      <div class="container">
        ...
        <td class="navbar-item-containers" width="75%">
			<form  method="POST" action="search.php?go" name="search" id="searchform"> 
				<input id="search-bar" class="form-control" type="text" name="searchS" placeholder="Search..."></input>
        </td>
        <td class="navbar-item-containers" width="5%">
				<button id="nav-button4" name="search" value="Search" type="submit" class="btn nav-btn"></button>
